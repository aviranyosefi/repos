        ...
        adjData.forEach(function (element) {
            ...
            if (element.serialMultipleOut != null || element.serialMultipleOut != "[]") {
                ...
                try {
                    ...
                    var serialItem = element.initialitem
                    var serialLocation = element.location_header
                    var serialMultipleOut = element.serialMultipleOut.split('\u0005');

                    var serialObjOut = makeSerialObj(serialMultipleOut, allSerials, serialLocation, serialItem);
...
function makeSerialObj(arr, allSerials, serialLocation, serialItem) {
    ...
    for (var i = 0; i < allSerials.length; i++) {
        ...
        for (var x = 0; x < arr.length; x++) {
            ...
            if ((arr[x] == allSerials[i].serialName) && (serialLocation == allSerials[i].serialLocation) && (serialItem == allSerials[i].serialItem)) {
