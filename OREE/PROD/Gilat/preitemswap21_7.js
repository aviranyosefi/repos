...
function insertnewlineitem(vrItem, index) {
    ...
    nlapiSetLineItemValue('item', 'custcol_scm_itemsub_original_item', index, nlapiGetLineItemValue('item', 'item', index + 1));
    ...
    nlapiSetLineItemValue('item', 'quantity', index, nlapiGetLineItemValue('item', 'quantity', index + 1));
...
function createvritem(income, clas) {
    ...
    item = nlapiCopyRecord('noninventoryitem', 3337);  //1528
