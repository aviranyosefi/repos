function update_sup_number_country() {
                ...
                for (y = 1; y <= itemCount; y++) {
                    if (rec.getLineItemValue('item', 'line', y) == line) {
                        ...
                        if (((i + 1) == s.length) || (s[i + 1].id != recId)) {
                            ...
                            nlapiLogExecution('debug', 'Submittion - tranID: ' + submition + ', type: ' + recType, 'line: ' + line + ', supNumber: ' + supNumber + ', country: ' + country);
                        }
                        else {
                            nlapiLogExecution('debug', 'update- tranID: ' + recId + ', type: ' + recType, 'line: ' + line + ', supNumber: ' + supNumber + ', country: ' + country);
                        }
                    }
                }
            }
