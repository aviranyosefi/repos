function sethtml() {
    try {
        ...
        issue.style.fontSize = "15px";

        customer_list = document.getElementById('custevent_customer_list');
        customer_list.style.fontSize = "15px";

        incomingmessage = document.getElementById('incomingmessage');
        incomingmessage.style.fontSize = "15px";
