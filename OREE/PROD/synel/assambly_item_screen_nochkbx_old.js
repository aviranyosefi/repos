...
function invSearch() {
    ...
    var search = nlapiLoadSearch(null, 'customsearch_assembly_components');
    //search.addFilter(new nlobjSearchFilter('internalid', null, 'is', machine));

    //if (!isNullOrEmpty(itemVal)) {
    //    search.addFilter(new nlobjSearchFilter('memberitem', null, 'anyof', itemVal));
    //}
