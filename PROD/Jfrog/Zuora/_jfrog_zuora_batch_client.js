...
function firstmail_SaveRecord() {
    ...
    nlapiLogExecution('DEBUG', 'toSendLineCount', toSendLineCount)
    if (toSendLineCount != 0) {
        ...
        for (var i = 0; i < toSendLineCount; i++) {
            ...
            var toSend_type = nlapiGetLineItemValue('custpage_results_sublist', 'custpage_resultssublist_type', i + 1);
            ...
            nlapiLogExecution('DEBUG', 'jsonString_toSend', jsonString_toSend)
