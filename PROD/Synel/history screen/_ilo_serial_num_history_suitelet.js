...
function getAllSerials(serialName) {
    ...
    var strFormula = "{inventorynumber}";
    filtersInvoice[0] = new nlobjSearchFilter("formulatext", null, 'is', serialName).setFormula(strFormula);
...
function getSerialTrans(serial, itemID, serialID) {
    ...
    filters[0] = new nlobjSearchFilter('serialnumber', null, 'is', serial);
    //filters[2] = new nlobjSearchFilter('inventorynumber', 'inventorydetail', 'anyof', serialID);
    filters[1] = new nlobjSearchFilter('type', null, 'noneof', ['TrnfrOrd']);
...
function getTypeName(value) {
    //nlapiLogExecution('DEBUG', 'getTypeName value: ', value);
    var clean = '';
