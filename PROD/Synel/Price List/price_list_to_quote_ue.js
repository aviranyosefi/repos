...
if (customer_price_list != '' && customer_price_list != undefined && customer_price_list != null && customer_pl_approval == 'T') {
    ...
    //var start_date = nlapiLookupField('customtransaction_price_list', customer_price_list, 'custbody_effective_start_date');
    //var start_date_obj = nlapiStringToDate(start_date);
    //var expiration_date = nlapiLookupField('customtransaction_price_list', customer_price_list, 'custbody_expiration_date');
    //var expiration_date_obj = nlapiStringToDate(expiration_date);
    //if (start_date_obj <= today && today <= expiration_date_obj) {
    //    var plRec = nlapiLoadRecord('customtransaction_price_list', customer_price_list);
    //    var plRec_items = plRec.getLineItemCount('line');
...
if (customer_generic_price_list != '' && customer_generic_price_list != undefined && customer_generic_price_list != null && generic_pl_approval == 'T') {
    ...
    //var generic_start_date = nlapiLookupField('customtransaction_price_list', customer_generic_price_list, 'custbody_effective_start_date');
    //var generic_start_date_obj = nlapiStringToDate(generic_start_date);
    //var generic_expiration_date = nlapiLookupField('customtransaction_price_list', customer_generic_price_list, 'custbody_expiration_date');
    //var generic_expiration_date_obj = nlapiStringToDate(generic_expiration_date);
    //if (generic_start_date_obj <= today && today <= generic_expiration_date_obj) {
    //    var generic_plRec = nlapiLoadRecord('customtransaction_price_list', customer_generic_price_list);
    //    var generic_plRec_items = generic_plRec.getLineItemCount('line');
...
function gilat_price(itemm) {
    ...
    //var type_item = rec.getLineItemValue('item', 'itemtype', line);

    //nlapiLogExecution('debug', 'type_item()', type_item)
    //if (type_item == 'InvtPart') { type_item = rec.getLineItemValue('item', 'custcol_baserecordtype', line) }
