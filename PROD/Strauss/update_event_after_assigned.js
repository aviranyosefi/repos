        ...
        try {
            ...
            if (!isNullOrEmpty(scheduled_event)) {
                ...
                if (new_assigned != old_assigned) {            
                    ...
                    updateEvent(scheduled_event, new_assigned, old_assigned, company, case_type)                  
                }
...
function updateEvent(scheduled_event, new_assigned, old_assigned, company, case_type) {
    try {
            ...
            rec.setFieldValue('title', new_entityid + ' - ' + case_type + ' (' + comapnyName + ')')
