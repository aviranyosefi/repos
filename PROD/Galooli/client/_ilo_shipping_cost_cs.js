...
function getAllShippingPrices_Israel() {
    ...
    if (role != '14') {
        ...
        cols[3] = new nlobjSearchColumn('custrecord_fedex_delivery_cost');
        ...
        if (s != null) {
            ...
            for (var i = 0; i < s.length; i++) {
                ...
                resultsArr.push({
                    ...
                    fedexPrice: s[i].getValue('custrecord_fedex_delivery_cost'),
                });
    ...
    if (role != '14') {
        ...
        if (subsid == '1' && currRec != exception) {
            ...
            if (name == 'custbody_ilo_gal_special_shipping' && role != '14' && subsid == '1') {
                ...
                //var manually_changed = nlapiGetFieldValue('custbody_manually_changed');
                //if (manually_changed != 'T' && getShipping != newShipping.toFixed(2)) {
    ...
    if (role != '14') {
        if (subsid == '1' && currRec != exception) {
            ...
            if (checkManCountry == 'IL' && checkifSelfPickup == 'F') {
                ...
                //var manually_changed = nlapiGetFieldValue('custbody_manually_changed');
                //if (manually_changed != 'T' && getShipping != parseFloat(totalShip + getShipping).toFixed(2)) {
    ...
    if (totalweight != 0 || totalweight != '0') {
        ...
        for (var i = 0; i < shippingPricesIsrael.length; i++) {
            ...
            if (shippingPricesIsrael[i].weight == tot_weight) {
                ...
                if (shippingType == '3') { // FEDEX
                    price = shippingPricesIsrael[i].fedexPrice
                    if (price == null || price == "" || price == undefined) {
                        alert('No FEDEX shipping price for this weight.')
                    }
                }
            }
        }
...
function checkAndUpdateShipping(lineNum, customerid) {
    ...
    if (itemRec != undefined) {
        ...
        //var manually_changed = nlapiGetFieldValue('custbody_manually_changed');
        //if (manually_changed != 'T' && shippingcost != totalShip.toFixed(2)) {
