...
function getSerialNumber(request, response) {
    ...
    try {
        ...
        if (request.getMethod() == 'GET') {
            ...
            //WARRANTY Fields - start
            var warranty_exp_date = form.addField('custpage_warranty_exp_date', 'text', 'VENDOR WARRANTY EXPIRATION DATE', null, 'custpage_sum_group');
            warranty_exp_date.setDisplayType('inline');

            var vendor_warranty_from = form.addField('custpage_vendor_warranty_from', 'text', 'VENDOR WARRANTY FROM', null, 'custpage_sum_group');
            vendor_warranty_from.setDisplayType('inline');

            var vendor_warranty_to = form.addField('custpage_vendor_warranty_to', 'text', 'CUSTOMER WARRANTY EXPIRATION DATE', null, 'custpage_sum_group');
            vendor_warranty_to.setDisplayType('inline');

            var customer_warranty_from = form.addField('custpage_customer_warranty_from', 'text', 'CUSTOMER WARRANTY FROM', null, 'custpage_sum_group');
            customer_warranty_from.setDisplayType('inline');
            ...
            //WARRANTY Fields - start
            var warranty_exp_date = resForm.addField('custpage_warranty_exp_date', 'text', 'VENDOR WARRANTY EXPIRATION DATE', null, 'custpage_sum_group');
            warranty_exp_date.setDisplayType('inline');

            var vendor_warranty_from = resForm.addField('custpage_vendor_warranty_from', 'text', 'VENDOR WARRANTY FROM', null, 'custpage_sum_group');
            vendor_warranty_from.setDisplayType('inline');

            var vendor_warranty_to = resForm.addField('custpage_vendor_warranty_to', 'text', 'CUSTOMER WARRANTY EXPIRATION DATE', null, 'custpage_sum_group');
            vendor_warranty_to.setDisplayType('inline');

            var customer_warranty_from = resForm.addField('custpage_customer_warranty_from', 'text', 'CUSTOMER WARRANTY FROM', null, 'custpage_sum_group');
            customer_warranty_from.setDisplayType('inline');
            ...
            var exp_date_field = nlapiLookupField('inventorynumber', serialID, 'custitemnumber_warranty_exp_date')
            var vendor_warranty_from_field = nlapiLookupField('inventorynumber', serialID, 'custitemnumber_vendor_warranty_from')
            var vendor_warranty_to_field = nlapiLookupField('inventorynumber', serialID, 'custitemnumber_vendor_warranty_to')
            var customer_warranty_from_field = nlapiLookupField('inventorynumber', serialID, 'custitemnumber_customer_warranty_from')
            ...
            function getItemHeaderDetails(lastType, lastTranID, lastBin, itemID) {
                try {
                    ...
                    if (lastType != null) {
                        ...
                        warranty_exp_date.setDefaultValue(exp_date_field)
                        vendor_warranty_from.setDefaultValue(vendor_warranty_from_field)
                        vendor_warranty_to.setDefaultValue(vendor_warranty_to_field)
                        customer_warranty_from.setDefaultValue(customer_warranty_from_field)
...
function getTransactions(serial) {
    nlapiLogExecution('debug', 'getTransactions serial', serial)
    ...
    filtersInvoice[0] = new nlobjSearchFilter('serialnumber', null, 'is', serial)

    var columnsInvoice = new Array();
    columnsInvoice[0] = new nlobjSearchColumn('item');
    columnsInvoice[1] = new nlobjSearchColumn('inventorynumber', 'inventorydetail');




    var searchSerial = nlapiCreateSearch('transaction', filtersInvoice, columnsInvoice);
...
function getAllSerials(serialName) {
    ...
    var filtersInvoice = new Array();
    filtersInvoice[0] = new nlobjSearchFilter('inventorynumber', null, 'is', serialName)

    var columnsInvoice = new Array();
    columnsInvoice[0] = new nlobjSearchColumn('inventorynumber');
    columnsInvoice[1] = new nlobjSearchColumn('internalid');
    columnsInvoice[2] = new nlobjSearchColumn('location');
    columnsInvoice[3] = new nlobjSearchColumn('quantityonhand');
    columnsInvoice[4] = new nlobjSearchColumn('item');


    var searchSerials = nlapiCreateSearch('inventorynumber', filtersInvoice, columnsInvoice);
