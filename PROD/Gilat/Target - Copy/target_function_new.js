        ...
        if (allSelection != null) {
            for (var i = 0; i < allSelection.length; i++) {
                ...
                if (!isNullOrEmpty(data)) {
                    var dataSplitSecond = splitDataAmountSecondPf(data)
                    var target_dataSplitSecond = splitTargetAmountSecondPf(data)                    
                    sumOfHLS0 = dataSplitSecond[0].gt
                    sumOfHLS1 = dataSplitSecond[1].gt
                    sumOfHLS2 = dataSplitSecond[2].gt
                    sumOfHLS3 = dataSplitSecond[3].gt
                    sumOfHLS4 = dataSplitSecond[4].gt
                    sumOfHLS5 = dataSplitSecond[5].gt
                    sumOfHLS6 = dataSplitSecond[6].gt
                    sumOfHLS7 = dataSplitSecond[7].gt
                    sumOfHLS8 = dataSplitSecond[8].gt
                    sumOfHLS9 = dataSplitSecond[9].gt
                    sumOfHLS10 = dataSplitSecond[10].gt
                    sumOfHLS11 = dataSplitSecond[11].gt
                    target1 = target_dataSplitSecond[0].gt
                    target2 = target_dataSplitSecond[1].gt
                    target3 = target_dataSplitSecond[2].gt
                    target4 = target_dataSplitSecond[3].gt
                    target5 = target_dataSplitSecond[4].gt
                    target6 = target_dataSplitSecond[5].gt
                    target7 = target_dataSplitSecond[6].gt
                    target8 = target_dataSplitSecond[7].gt
                    target9 = target_dataSplitSecond[8].gt
                    target10 = target_dataSplitSecond[9].gt
                    target11 = target_dataSplitSecond[10].gt
                    target12 = target_dataSplitSecond[11].gt

                    sumOfHW0 = dataSplitSecond[0].dhls_hw + dataSplitSecond[0].hw
                    sumOfHW1 = dataSplitSecond[1].dhls_hw + dataSplitSecond[1].hw
                    sumOfHW2 = dataSplitSecond[2].dhls_hw + dataSplitSecond[2].hw
                    sumOfHW3 = dataSplitSecond[3].dhls_hw + dataSplitSecond[3].hw
                    sumOfHW4 = dataSplitSecond[4].dhls_hw + dataSplitSecond[4].hw
                    sumOfHW5 = dataSplitSecond[5].dhls_hw + dataSplitSecond[5].hw
                    sumOfHW6 = dataSplitSecond[6].dhls_hw + dataSplitSecond[6].hw
                    sumOfHW7 = dataSplitSecond[7].dhls_hw + dataSplitSecond[7].hw
                    sumOfHW8 = dataSplitSecond[8].dhls_hw + dataSplitSecond[8].hw
                    sumOfHW9 = dataSplitSecond[9].dhls_hw + dataSplitSecond[9].hw
                    sumOfHW10 = dataSplitSecond[10].dhls_hw + dataSplitSecond[10].hw
                    sumOfHW11 = dataSplitSecond[11].dhls_hw + dataSplitSecond[11].hw
                    target1sumOfHW = target_dataSplitSecond[0].dhls_hw + target_dataSplitSecond[0].hw
                    target2sumOfHW = target_dataSplitSecond[1].dhls_hw + target_dataSplitSecond[1].hw
                    target3sumOfHW = target_dataSplitSecond[2].dhls_hw + target_dataSplitSecond[2].hw
                    target4sumOfHW = target_dataSplitSecond[3].dhls_hw + target_dataSplitSecond[3].hw
                    target5sumOfHW = target_dataSplitSecond[4].dhls_hw + target_dataSplitSecond[4].hw
                    target6sumOfHW = target_dataSplitSecond[5].dhls_hw + target_dataSplitSecond[5].hw
                    target7sumOfHW = target_dataSplitSecond[6].dhls_hw + target_dataSplitSecond[6].hw
                    target8sumOfHW = target_dataSplitSecond[7].dhls_hw + target_dataSplitSecond[7].hw
                    target9sumOfHW = target_dataSplitSecond[8].dhls_hw + target_dataSplitSecond[8].hw
                    target10sumOfHW = target_dataSplitSecond[9].dhls_hw + target_dataSplitSecond[9].hw
                    target11sumOfHW = target_dataSplitSecond[10].dhls_hw + target_dataSplitSecond[10].hw
                    target12sumOfHW = target_dataSplitSecond[11].dhls_hw + target_dataSplitSecond[11].hw

                    sumOfIC0 =clcdPfSum(data, 0)
                    sumOfIC1 = clcdPfSum(data, 1)
                    sumOfIC2 = clcdPfSum(data, 2)
                    sumOfIC3 = clcdPfSum(data, 3)
                    sumOfIC4 = clcdPfSum(data, 4)
                    sumOfIC5 = clcdPfSum(data, 5)
                    sumOfIC6 = clcdPfSum(data, 6)
                    sumOfIC7 = clcdPfSum(data, 7)
                    sumOfIC8 = clcdPfSum(data, 8)
                    sumOfIC9 = clcdPfSum(data, 9)
                    sumOfIC10 = clcdPfSum(data, 10)
                    sumOfIC11 = clcdPfSum(data, 11)
                    target1sumOfIC = clcdPfTarget(data, 0)
                    target2sumOfIC = clcdPfTarget(data, 1)
                    target3sumOfIC = clcdPfTarget(data, 2)
                    target4sumOfIC = clcdPfTarget(data, 3)
                    target5sumOfIC = clcdPfTarget(data, 4)
                    target6sumOfIC = clcdPfTarget(data, 5)
                    target7sumOfIC = clcdPfTarget(data, 6)
                    target8sumOfIC = clcdPfTarget(data, 7)
                    target9sumOfIC = clcdPfTarget(data, 8)
                    target10sumOfIC = clcdPfTarget(data, 9)
                    target11sumOfIC = clcdPfTarget(data, 10)
                    target12sumOfIC = clcdPfTarget(data, 11)

                    var totalmount = sumOfHLS0 + sumOfHLS1 + sumOfHLS2 + sumOfHLS3 + sumOfHLS4 + sumOfHLS5 + sumOfHLS6 + sumOfHLS7 + sumOfHLS8 + sumOfHLS9 + sumOfHLS10 + sumOfHLS11
                    var totaltarget= target1+target2+target3+target4+target5+target6+target7+target8+target9+target10+target11+target12                    
                    var totalsumOfHW = sumOfHW0 + sumOfHW1 + sumOfHW2 + sumOfHW3 + sumOfHW4 + sumOfHW5 + sumOfHW6 + sumOfHW7 + sumOfHW8 + sumOfHW9 + sumOfHW10 + sumOfHW11
                    var totaltargetsumOfHW = target1sumOfHW + target2sumOfHW + target3sumOfHW + target4sumOfHW + target5sumOfHW + target6sumOfHW + target7sumOfHW + target8sumOfHW + target9sumOfHW + target10sumOfHW + target11sumOfHW + target12sumOfHW
                    var totalsumOfIC = sumOfIC0 + sumOfIC1 + sumOfIC2 + sumOfIC3 + sumOfIC4 + sumOfIC5 + sumOfIC6 + sumOfIC7 + sumOfIC8 + sumOfIC9 + sumOfIC10 + sumOfIC11
                    var totaltargetsumOfIC =target1sumOfIC + target2sumOfIC + target3sumOfIC + target4sumOfIC + target5sumOfIC + target6sumOfIC + target7sumOfIC + target8sumOfIC + target9sumOfIC + target11sumOfIC + target12sumOfIC

                    Results.push({
                        id: allSelection[i].id,
                        sales_rep: getName(allSelection[i].getText("custrecord_sr_sales_rep")),
                        sales_rep_id: allSelection[i].getValue("custrecord_sr_sales_rep"),
                        mounth1: formatNumber(sumOfHLS0),
                        mounth2: formatNumber(sumOfHLS1),
                        mounth3: formatNumber(sumOfHLS2),
                        mounth4: formatNumber(sumOfHLS3),
                        mounth5: formatNumber(sumOfHLS4),
                        mounth6: formatNumber(sumOfHLS5),
                        mounth7: formatNumber(sumOfHLS6),
                        mounth8: formatNumber(sumOfHLS7),
                        mounth9: formatNumber(sumOfHLS8),
                        mounth10: formatNumber(sumOfHLS9),
                        mounth11: formatNumber(sumOfHLS10),
                        mounth12: formatNumber(sumOfHLS11),
                        totalmount: formatNumber(totalmount),
                        mounth1sumOfHW: formatNumber(sumOfHW0),
                        mounth2sumOfHW: formatNumber(sumOfHW1),
                        mounth3sumOfHW: formatNumber(sumOfHW2),
                        mounth4sumOfHW: formatNumber(sumOfHW3),
                        mounth5sumOfHW: formatNumber(sumOfHW4),
                        mounth6sumOfHW: formatNumber(sumOfHW5),
                        mounth7sumOfHW: formatNumber(sumOfHW6),
                        mounth8sumOfHW: formatNumber(sumOfHW7),
                        mounth9sumOfHW: formatNumber(sumOfHW8),
                        mounth10sumOfHW: formatNumber(sumOfHW9),
                        mounth11sumOfHW: formatNumber(sumOfHW10),
                        mounth12sumOfHW: formatNumber(sumOfHW11),
                        totalsumOfHW: formatNumber(totalsumOfHW),
                        mounth1sumOfIC: formatNumber(sumOfIC0),
                        mounth2sumOfIC: formatNumber(sumOfIC1),
                        mounth3sumOfIC: formatNumber(sumOfIC2),
                        mounth4sumOfIC: formatNumber(sumOfIC3),
                        mounth5sumOfIC: formatNumber(sumOfIC4),
                        mounth6sumOfIC: formatNumber(sumOfIC5),
                        mounth7sumOfIC: formatNumber(sumOfIC6),
                        mounth8sumOfIC: formatNumber(sumOfIC7),
                        mounth9sumOfIC: formatNumber(sumOfIC8),
                        mounth10sumOfIC: formatNumber(sumOfIC9),
                        mounth11sumOfIC: formatNumber(sumOfIC10),
                        mounth12sumOfIC: formatNumber(sumOfIC11),
                        ...
                        target5: formatNumber(target5),
                        target6: formatNumber(target6),
                        target7: formatNumber(target7),
                        target8: formatNumber(target8),
                        target9: formatNumber(target9),
                        target10: formatNumber(target10),
                        target11: formatNumber(target11),
                        target12: formatNumber(target12),
                        totaltarget: formatNumber(totaltarget),
                        ...
                        target5sumOfHW: formatNumber(target5sumOfHW),
                        target6sumOfHW: formatNumber(target6sumOfHW),
                        target7sumOfHW: formatNumber(target7sumOfHW),
                        target8sumOfHW: formatNumber(target8sumOfHW),
                        target9sumOfHW: formatNumber(target9sumOfHW),
                        target10sumOfHW: formatNumber(target10sumOfHW),
                        target11sumOfHW: formatNumber(target11sumOfHW),
                        target12sumOfHW: formatNumber(target12sumOfHW),
                        ...
                        target5sumOfIC: formatNumber(target5sumOfIC),
                        target6sumOfIC: formatNumber(target6sumOfIC),
                        target7sumOfIC: formatNumber(target7sumOfIC),
                        target8sumOfIC: formatNumber(target8sumOfIC),
                        target9sumOfIC: formatNumber(target9sumOfIC),
                        target10sumOfIC: formatNumber(target10sumOfIC),
                        target11sumOfIC: formatNumber(target11sumOfIC),
                        target12sumOfIC: formatNumber(target12sumOfIC),
                        totaltargetsumOfIC: formatNumber(totaltargetsumOfIC),
                        gap1: formatNumber(sumOfHLS0- target1),
                        gap2: formatNumber(sumOfHLS1 - target2),
                        gap3: formatNumber(sumOfHLS2 - target3),
                        gap4: formatNumber(sumOfHLS3 - target4),
                        gap5: formatNumber(sumOfHLS4 - target5),
                        gap6: formatNumber(sumOfHLS5 - target6),
                        gap7: formatNumber(sumOfHLS6 - target7),
                        gap8: formatNumber(sumOfHLS7 - target8),
                        gap9: formatNumber(sumOfHLS8 - target9),
                        gap10: formatNumber(sumOfHLS9 - target10),
                        gap11: formatNumber(sumOfHLS10 - target11),
                        gap12: formatNumber(sumOfHLS11 - target12),
                        totalgap: formatNumber(totalmount - totaltarget),
                        gap1sumOfHW: formatNumber(sumOfHW0 - target1sumOfHW),
                        gap2sumOfHW: formatNumber(sumOfHW1 - target2sumOfHW),
                        gap3sumOfHW: formatNumber(sumOfHW2 - target3sumOfHW),
                        gap4sumOfHW: formatNumber(sumOfHW3 - target4sumOfHW),
                        gap5sumOfHW: formatNumber(sumOfHW4 - target5sumOfHW),
                        gap6sumOfHW: formatNumber(sumOfHW5 - target6sumOfHW),
                        gap7sumOfHW: formatNumber(sumOfHW6 - target7sumOfHW),
                        gap8sumOfHW: formatNumber(sumOfHW7 - target8sumOfHW),
                        gap9sumOfHW: formatNumber(sumOfHW8 - target9sumOfHW),
                        gap10sumOfHW: formatNumber(sumOfHW9 - target10sumOfHW),
                        gap11sumOfHW: formatNumber(sumOfHW10 - target11sumOfHW),
                        gap12sumOfHW: formatNumber(sumOfHW11 - target12sumOfHW),
                        totalgapsumOfHW: formatNumber(totalsumOfHW - totaltargetsumOfHW),
                        gap1sumOfIC: formatNumber(sumOfIC0 - target1sumOfIC),
                        gap2sumOfIC: formatNumber(sumOfIC1 - target2sumOfIC),
                        gap3sumOfIC: formatNumber(sumOfIC2 - target3sumOfIC),
                        gap4sumOfIC: formatNumber(sumOfIC3 - target4sumOfIC),
                        gap5sumOfIC: formatNumber(sumOfIC4 - target5sumOfIC),
                        gap6sumOfIC: formatNumber(sumOfIC5 - target6sumOfIC),
                        gap7sumOfIC: formatNumber(sumOfIC6 - target7sumOfIC),
                        gap8sumOfIC: formatNumber(sumOfIC7 - target8sumOfIC),
                        gap9sumOfIC: formatNumber(sumOfIC8 - target9sumOfIC),
                        gap10sumOfIC: formatNumber(sumOfIC9 - target10sumOfIC),
                        gap11sumOfIC: formatNumber(sumOfIC10 - target11sumOfIC),
                        gap12sumOfIC: formatNumber(sumOfIC11 - target12sumOfIC),
                        totalgapsumOfIC: formatNumber(totalsumOfIC - totaltargetsumOfIC),
                        perc1: formatNumber(getPrecenge(sumOfHLS0, target1)) + '%',
                        perc2: formatNumber(getPrecenge(sumOfHLS1, target2)) + '%',
                        perc3: formatNumber(getPrecenge(sumOfHLS2, target3)) + '%',
                        perc4: formatNumber(getPrecenge(sumOfHLS3, target4)) + '%',
                        perc5: formatNumber(getPrecenge(sumOfHLS4, target5)) + '%',
                        perc6: formatNumber(getPrecenge(sumOfHLS5, target6)) + '%',
                        perc7: formatNumber(getPrecenge(sumOfHLS6, target7)) + '%',
                        perc8: formatNumber(getPrecenge(sumOfHLS7, target8)) + '%',
                        perc9: formatNumber(getPrecenge(sumOfHLS8, target9)) + '%',
                        perc10: formatNumber(getPrecenge(sumOfHLS9, target10)) + '%',
                        perc11: formatNumber(getPrecenge(sumOfHLS10, target11)) + '%',
                        perc12: formatNumber(getPrecenge(sumOfHLS11, target12)) + '%',
                        totalperc: formatNumber(getPrecenge(totalmount, totaltarget)) + '%',
                        perc1sumOfHW: formatNumber(getPrecenge(sumOfHW0, target1sumOfHW)) + '%',
                        perc2sumOfHW: formatNumber(getPrecenge(sumOfHW1, target2sumOfHW)) + '%',
                        perc3sumOfHW: formatNumber(getPrecenge(sumOfHW2, target3sumOfHW)) + '%',
                        perc4sumOfHW: formatNumber(getPrecenge(sumOfHW3, target4sumOfHW)) + '%',
                        perc5sumOfHW: formatNumber(getPrecenge(sumOfHW4, target5sumOfHW)) + '%',
                        perc6sumOfHW: formatNumber(getPrecenge(sumOfHW5, target6sumOfHW)) + '%',
                        perc7sumOfHW: formatNumber(getPrecenge(sumOfHW6, target7sumOfHW)) + '%',
                        perc8sumOfHW: formatNumber(getPrecenge(sumOfHW7, target8sumOfHW)) + '%',
                        perc9sumOfHW: formatNumber(getPrecenge(sumOfHW8, target9sumOfHW)) + '%',
                        perc10sumOfHW: formatNumber(getPrecenge(sumOfHW9, target10sumOfHW)) + '%',
                        perc11sumOfHW: formatNumber(getPrecenge(sumOfHW10, target11sumOfHW)) + '%',
                        perc12sumOfHW: formatNumber(getPrecenge(sumOfHW11, target12sumOfHW)) + '%',
                        totalpercsumOfHW: formatNumber(getPrecenge(totalsumOfHW, totaltargetsumOfHW)) + '%',
                        perc1sumOfIC: formatNumber(getPrecenge(sumOfIC0, target1sumOfIC)) + '%',
                        perc2sumOfIC: formatNumber(getPrecenge(sumOfIC1, target2sumOfIC)) + '%',
                        perc3sumOfIC: formatNumber(getPrecenge(sumOfIC2, target3sumOfIC)) + '%',
                        perc4sumOfIC: formatNumber(getPrecenge(sumOfIC3, target4sumOfIC)) + '%',
                        perc5sumOfIC: formatNumber(getPrecenge(sumOfIC4, target5sumOfIC)) + '%',
                        perc6sumOfIC: formatNumber(getPrecenge(sumOfIC5, target6sumOfIC)) + '%',
                        perc7sumOfIC: formatNumber(getPrecenge(sumOfIC6, target7sumOfIC)) + '%',
                        perc8sumOfIC: formatNumber(getPrecenge(sumOfIC7, target8sumOfIC)) + '%',
                        perc9sumOfIC: formatNumber(getPrecenge(sumOfIC8, target9sumOfIC)) + '%',
                        perc10sumOfIC: formatNumber(getPrecenge(sumOfIC9, target10sumOfIC)) + '%',
                        perc11sumOfIC: formatNumber(getPrecenge(sumOfIC10, target11sumOfIC)) + '%',
                        perc12sumOfIC: formatNumber(getPrecenge(sumOfIC11, target12sumOfIC)) + '%',
        ...
        if (allSelection != null) {
            for (var i = 0; i < allSelection.length; i++) {
                ...
                if (!isNullOrEmpty(data)) {
                    ...
                    target12sumOfIC = clcdPfTarget(data, 11)
                    ////
                    var quoarterly1 = sumOfHLS0 + sumOfHLS1 + sumOfHLS2;
                    var quoarterly2 = sumOfHLS3 + sumOfHLS4 + sumOfHLS5;
                    var quoarterly3 = sumOfHLS6 + sumOfHLS7 + sumOfHLS8;
                    var quoarterly4 = sumOfHLS9 + sumOfHLS10 + sumOfHLS11;
                    var totalquoarterly = quoarterly1 + quoarterly2 + quoarterly3 + quoarterly4;

                    var quoarterly1sumOfHW = sumOfHW0 + sumOfHW1 + sumOfHW2;
                    var quoarterly2sumOfHW = sumOfHW3 + sumOfHW4 + sumOfHW5;
                    var quoarterly3sumOfHW = sumOfHW6 + sumOfHW7 + sumOfHW8;
                    var quoarterly4sumOfHW = sumOfHW9 + sumOfHW10 + sumOfHW11;
                    var totalquoarterlysumOfHW = quoarterly1sumOfHW + quoarterly2sumOfHW + quoarterly3sumOfHW + quoarterly4sumOfHW

                    var quoarterly1sumOfIC = sumOfIC0 + sumOfIC1 + sumOfIC2;
                    var quoarterly2sumOfIC = sumOfIC3 + sumOfIC4 + sumOfIC5;
                    var quoarterly3sumOfIC = sumOfIC6 + sumOfIC7 + sumOfIC8;
                    var quoarterly4sumOfIC = sumOfIC9 + sumOfIC10 + sumOfIC11;
                    ...
                    var target1sumOfHW = target1sumOfHW + target2sumOfHW + target3sumOfHW
                    var target2sumOfHW = target4sumOfHW + target5sumOfHW + target6sumOfHW
                    var target3sumOfHW = target7sumOfHW + target8sumOfHW + target9sumOfHW
                    var target4sumOfHW = target10sumOfHW + target11sumOfHW + target12sumOfHW
                    var totaltargetsumOfHW = target1sumOfHW + target2sumOfHW + target3sumOfHW + target4sumOfHW;

                    var target1sumOfIC = target1sumOfIC + target2sumOfIC + target3sumOfIC
                    var target2sumOfIC = target4sumOfIC + target5sumOfIC + target6sumOfIC
                    var target3sumOfIC = target7sumOfIC + target8sumOfIC + target9sumOfIC
                    var target4sumOfIC = target10sumOfIC + target11sumOfIC + target12sumOfIC
        ...
        if (allSelection != null) {
            ...
            for (var i = 0; i < allSelection.length; i++) {
                ...
                if (!isNullOrEmpty(data)) {
                    ...
                    var halfYearly1sumOfHW = quoarterly1sumOfHW + quoarterly2sumOfHW
                    var halfYearly2sumOfHW = quoarterly3sumOfHW + quoarterly4sumOfHW
                    var totalhalfYearlysumOfHW = halfYearly1sumOfHW + halfYearly2sumOfHW;
                    var target1sumOfHW = target1sumOfHW + target2sumOfHW
                    var target2sumOfHW = target3sumOfHW + target4sumOfHW
                    var totaltargetsumOfHW = target1sumOfHW + target2sumOfHW;

                    var halfYearly1sumOfIC = quoarterly1sumOfIC + quoarterly2sumOfIC
                    var halfYearly2sumOfIC = quoarterly3sumOfIC + quoarterly4sumOfIC
                    var totalhalfYearlysumOfIC = halfYearly1sumOfIC + halfYearly2sumOfIC;           
                    var target1sumOfIC = target1sumOfIC + target2sumOfIC
                    var target2sumOfIC = target3sumOfIC + target4sumOfIC
