function target_screen(request, response) {
    ...
    if (request.getParameter('custpage_dimension') == '') {
                    ...
                    for (var m = 0; m < 4; m++) {
                        if (z == 0) {
                            if (m == 0) {
                                ...
                                var mounth10 = "<a style='color:" + GCM(re[i].perc10, 11) + "'" + " href='" + link + re[i].sales_rep_id + '&m=10&type=1' + '&year=' + yearData + '&dim=2' + '&dim=2' + "'" + 'target="_blank">' + re[i].mounth10 + "</a>";
                                var mounth11 = "<a style='color:" + GCM(re[i].perc11, 10) + "'" + " href='" + link + re[i].sales_rep_id + '&m=11&type=1' + '&year=' + yearData + '&dim=2' + "'" + 'target="_blank">' + re[i].mounth11 + "</a>";
        ...
        if (request.getParameter('custpage_ilo_type') == '1') { // Monthly
            ...
            s.addField('custpage_total_t', 'text', 'TOTAL');
            var line = 0;
            var re = SalesRepTargetsPf(salesData, yearData, fss_mssData, sales_dep_manData, sales_team_manData);
            for (var i = 0; i < re.length; i++) {
                line = (i * 64) + 1;
