...
define(['require', 'N/url', 'N/log', 'N/record', 'N/search', 'N/ui/serverWidget', '../Common/BE.Lib.Common.js', 'N/error', 'N/runtime', '../Common/DF.Helpers'],
    function (require, url, logger, record, search, serverWidget, common, error, runtime, helpers) {
        ...
        function beforeSubmit(scriptContext) {
            ...
            if (recType == record.Type.SALES_ORDER || recType == record.Type.OPPORTUNITY || recType == record.Type.ESTIMATE) {
            ...
            search.create({
                ...
                filters:
                    [
                        ...
                        "AND",
                        ["type", "anyof", "SalesOrd", "Estimate", "Opprtnty"],
                        "AND",
        ...
        /***************************************************************/
        /*Date:'7/3/2022' ,Editor: 'Stav Shlomovich', Task: 'DR1186', Desc: ''
        /***************************************************************/
        function createSOfromRMA(scriptContext) {

            var rmaData = scriptContext.request.parameters.rmaData;
