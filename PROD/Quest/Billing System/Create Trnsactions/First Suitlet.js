 ...
 */
 define(['N/search', 'N/runtime', 'N/format','N/record', 'N/task','N/http','N/ui/serverWidget','N/redirect','N/log'], function(search, runtime,format, record, task,http,serverWidget,redirect,log) {
    var exports = {};
    ...
    function onRequest(context) {
        ...
        if (context.request.method === 'GET'){
            ...
            var SearchData = GetSearch(Customer,Agr)
            log.debug({
                title: 'Search Data',
                details: SearchData
            })
    ...
    function GetSearch(Customer,Agr,Date){
       ...
       var filter_search = [['custrecord_bp_customer', 'anyof', Customer],'AND',['custrecord_bp_agr', 'anyof', Agr]]
       ...
       var bp_search = search.create({
           ...
           columns: [{name: 'custrecord_bp_service_start_date'},{name: 'custrecord_bp_service_end_date'},{name: 'custrecord_bp_amount'},{name: 'custrecord_bp_date_for_inv'},{ name: 'custrecord_ib_item', join: 'CUSTRECORD_BP_IB' }
