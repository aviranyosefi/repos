	...
	if (request.getMethod() == 'GET') {
		...
		response.writePage(form);
		 ...
		 htmlField1.setDefaultValue("<span style='font-size:18px'>An email with the documents will be sent to : <b> " +getUserMail+ "</b> once completed.<br></span>"); 
			 ...
			 var params = {custscript_ilo_awt_range_cbr: range,
							custscript_ilo_awt_email_cbr : getUserMail,
							custscript_ilo_awt_sender_cbr : getUserID,
							custscript_ilo_awt_subsid_cbr : getSubsid,
							custscript_ilo_awt_vendors_cbr : selectedVendors,
							custscript_ilo_awt_onlyactual_cbr : onlyActual,
							custscript_ilo_awt_template_cbr : template};
			 
			 nlapiScheduleScript('customscript_ilo_awt_scheduled_cbr', 'customdeploy_ilo_awt_scheduled_cbr', params);
