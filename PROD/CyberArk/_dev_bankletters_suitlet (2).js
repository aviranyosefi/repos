    ...
    if (request.getMethod() == 'GET') {
        ...
        if (printType == 'forbank') {
            ...
            var forBankString = '   <!--?xml version="1.0" ?-->  ' +
                ...
                '   <pdf>  ' +
                '   <head>  ' +
                '     <link name="sans-serif" type="font" subtype="truetype" src="https://4678143.app.netsuite.com/c.4678143/suitebundle46541/Localization-IL/Fonts/Heb-Regular.ttf"/>  ' +
                '       <style type="text/css">  ' +
                '           b {  ' +
                '               color: #444;  ' +
                '               font-weight: bold;  ' +
        ...
        if (printType == 'forvendor' && printLang == 'hebrew') {
            ...
            if (billTo != "" && billTo != null && billTo != undefined) {
                ...
                var vendorRec = nlapiLoadRecord("vendor", vendorID)
                billTo = vendorRec.getFieldValue('defaultaddress');
                if (billTo != "" && billTo != null && billTo != undefined) {
                    billTo = billTo.replaceAll('\n', '<br></br>')
                }
                else { billTo = nlapiLookupField('vendor', vendorID, 'companyname') }
