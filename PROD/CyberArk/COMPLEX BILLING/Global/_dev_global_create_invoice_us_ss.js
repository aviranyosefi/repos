...
function search_Billing() {
    ...
    try {
        ...
        filtersInvoice[2] = new nlobjSearchFilter('custrecord_be_subsidiary', null, 'anyof', ["18", "23"]);
...
function email(data) {
    try {
       ...
       for (v in data) {
        ...
        attachRec['employee'] = '2768' //attach email to customer record   
        try { nlapiSendEmail('2768', 'test@gmail.co.il', subject, body, null, null, attachRec, null, false); }
        catch (e) {
