 ...
 */
define(['N/search', 'N/record', 'N/log', 'N/error', 'N/runtime', '../Common/NCS.Lib.Common','./CBR.Lib.SFTP.Core', 'N/file', 'N/email', 'N/cache', 'N/format'],
...
function(search, record, logger, error, runtime, common, hypCore, file, email, cache, formatter) {
    ...
    function getInputData() {
		...
		if(!common.isNullOrEmpty(customFileName)){
    	...
    	var fileObj = hypCore.DownloadFile(connection, fileName, integId);
    	
    	//>>>>> Added to the script on 29/03/2018. This was instructed on NS Case #2971223
    	// Get destination folder
    	var folderId = common.getFolderId('SuFa Input Files');
