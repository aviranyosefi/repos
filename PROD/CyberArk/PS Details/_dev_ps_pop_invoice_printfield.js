...
function getTimeSheets(invoiceID) {
    ...
    columns[2] = new nlobjSearchColumn('custbody_ps_start_date').setSort(false);;
    ...
    columns[8] = new nlobjSearchColumn('custbody_ps_timecard');
    ...
    if (returnSearchResults != null) {
        returnSearchResults.forEach(function (element) {
            ...
            results.push({
                ...
                timecard: element.getValue('custbody_ps_timecard')
            });
