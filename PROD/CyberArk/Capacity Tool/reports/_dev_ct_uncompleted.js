...
function buildTable(ActualList, ForcastList) {
    ...
    //var period2 = getPeriod(date, '2');
    nlapiLogExecution('debug', 'emp', JSON.stringify(emp));
    var body = "<div style='width:100%' class='container-fluid'> " +
        " <div  class='container theme-showcase' role='main'><div class='col-md-12'>"
    var table = "<table class='table table-bordered table-hover'  style='text-align:center'><thead><tr><th>Reporter</th><th>Actual</th><th colspan='7'>Forecast</th><th>Email</th></tr></thead> ";
    table += "<tr><td></td><td>" + previous_period + "</td><td>" + periods[0] + "</td><td>" + periods[1] + "</td><td>" + periods[2] + "</td><td>" + periods[3] + "</td><td>" + periods[4] + "</td><td>" + periods[5] + "</td><td>" + periods[6] + "</td><td></td></tr>";
    //ActualKeys = Object.keys(ActualList);
    for (var i = 0; i < emp.length; i++) {
        ...
        if (ActualList[emp[i].id] != undefined || ForcastList[emp[i].id] != undefined) {
            if (ActualList[emp[i].id] != undefined) {
                var name = ActualList[emp[i].id].name
                count = ActualList[emp[i].id].count             
            }
            if (ForcastList[emp[i].id] != undefined) {
                var name = ForcastList[emp[i].id].name
            ...
            table += "<tr><td>" + name + "</td><td>" + count + "</td><td>" + current + "</td><td>" + m1 + "</td><td>" + m2 + "</td><td>" + m3 + "</td><td>" + m4 + "</td><td>" + m5 + "</td><td>" + m6 + "</td><td>" + email + "</td></tr>";
        }
    }
    table += "</table>"
    body += table;
