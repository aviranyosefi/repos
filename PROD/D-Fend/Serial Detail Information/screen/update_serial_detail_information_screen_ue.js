...
function beforeLoad_addButton(type, form) {
    if (type != 'create') {
        ...
        var hideBtn = nlapiLookupField('role', nlapiGetRole(), 'custrecord_hide_buttons')
...
function hideTransaction(form) {
    ...
    html += 'function grayOut_loading_hijack_save(){try{var btn=document.getElementById("custpage_rac_search_button"); btn.style.display ="none";}catch(t){console.log(t)}}grayOut_loading_hijack_save();'; html += '});';
    html += '</SCRIPT>';
