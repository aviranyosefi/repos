...
//					nlapiLogExecution('DEBUG', 'thisSubsidiary', thisSubsidiary);
				...
				var fromId = 16356; //AR JFrog LTD Internal ID
				...
				var msg = 'Dear '+contactFirstName+',<br><br> \n\rAttached please find JFrog LTD. invoice #'+thisInvoiceName+pleaseForward+addLicenseDates+'<br>Payment should be executed by a bank wire to our account (all detailed on top of the invoice).<br><br>Feel free to contact us for any further information you may need.<br>Best regards,<br>'+senderFirstName+'<br><br><p style="color:#43a047;font-size:14px;">JFrog is keeping the environment green. For a hard copy invoice, please contact: <span style="color:#43a047;font-size:14px;text-decoration:underline;">ar.il@jfrog.com</span></p><br><span style="color:#43a047"> Accounts Receivable | JFrog LTD </span><br><span style="color:#a9a9a9"> Tel. <u>+972-9-8941444</u> | U.S Toll Free Number: <u>1-888-70-40-670</u> </span><br><br>';
				...
				nlapiSendEmail(fromId,emailArr, sbj, msg, ['ar.il@jfrog.com', 'salesops@jfrog.com'], null, attachRec, attachment);
...
//					nlapiLogExecution('DEBUG', 'thisSubsidiary', thisSubsidiary);
					...
					var fromId = 16353; //AR JFrog INC Internal ID
					attachment = nlapiPrintRecord('TRANSACTION',thisInvoice,'PDF',null);
					...
					var msg = 'Dear '+contactFirstName+',<br><br> \n\rAttached please find JFrog INC. invoice #'+thisInvoiceName+pleaseForward+addLicenseDates+'<br>Payment can be made by an ACH/wire payment to our JFrog INC. bank account (details can be found on invoice).<br><br>Feel free to contact us for any further information you may need.<br>Best regards,<br>'+senderFirstName+'<br><br><p style="color:#43a047;font-size:14px;">JFrog is keeping the environment green. For a hard copy invoice, please contact: <span style="color:#43a047;font-size:14px;text-decoration:underline;">ar@jfrog.com</span></p><br><span style="color:#43a047"> Accounts Receivable | JFrog INC </span><br><span style="color:#a9a9a9"> Tel. <u>408-329-1540</u> | U.S Toll Free Number: <u>1-888-70-40-670</u></span><br><br>';
					var attachRec = new Object(); 
					attachRec['entity']=customerID; //attach email to customer record
					attachRec['transaction']=thisInvoice; //attach email to invoice record
					//multiple email addresses
					...
					nlapiSendEmail(fromId,emailArr, sbj, msg, ['ar@jfrog.com', 'salesops@jfrog.com'], null, attachRec, attachment);
...
//					nlapiLogExecution('DEBUG', 'thisSubsidiary', thisSubsidiary);
					...
					var fromId = 16355; //AR JFrog SAS Internal ID
					attachment = nlapiPrintRecord('TRANSACTION',thisInvoice,'PDF',null);
					if(typeof hasAttachment != 'undefined') {
						attachment = nlapiLoadFile(hasAttachment);
					}
					...
					var msg = 'Dear '+contactFirstName+',<br><br> \n\rAttached please find JFrog SAS. invoice #'+thisInvoiceName+pleaseForward+addLicenseDates+'<br>Payment should be executed by a bank wire to our account (all detailed on top of the invoice).<br><br>Feel free to contact us for any further information you may need.<br>Best regards,<br>'+senderFirstName+'<br><br><p style="color:#43a047;font-size:14px;">JFrog is keeping the environment green. For a hard copy invoice, please contact: <span style="color:#43a047;text-decoration:underline;">ar.fr@jfrog.com</span></p><br><span style="color:#43a047"> Accounts Receivable | JFrog SAS </span><br><span style="color:#a9a9a9"> Tel. <u>+33 (0)5 32 10 87 20 </u></span><br><br>';
					var attachRec = new Object(); 
					attachRec['entity']=customerID; //attach email to customer record
					attachRec['transaction']=thisInvoice; //attach email to invoice record
					//multiple email addresses
					...
					nlapiSendEmail(fromId,emailArr, sbj, msg, ['ar.fr@jfrog.com', 'salesops@jfrog.com'], null, attachRec, attachment);
