...
//			var senderName = senderFullName.split(' ');
			...
			var fromId = '18767'; //LTD AR EMPLOYEE
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rI hope this e-mail finds you well.<br><br>I would like to follow up with you, and make sure that you received invoice #'+thisInvoiceName+' sent to you via email.<br>Please let us know if there is any further information you may need.<br><br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog LTD </span><br><span style="color:#a9a9a9"> Tel. <u>+972-9-8941444</u> | U.S Toll Free Number: <u>1-888-70-40-670</u> </span><br><br>';
			...
			var fromId = '18769'; //SAS AR EMPLOYEE
			attachment = nlapiPrintRecord('TRANSACTION',thisInvoice,'PDF',null);
			if(hasAttachment != "") {
				attachment = nlapiLoadFile(hasAttachment);
			}
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rI hope this e-mail finds you well.<br><br>I would like to follow up with you, and make sure that you received invoice #'+thisInvoiceName+' sent to you via email.<br>Please let me know if there is any further information you may need.<br><br>Your reply and updates will be greatly appreciated.<br><br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog SAS </span><br><span style="color:#a9a9a9"> Tel. <u>+33 (0)5 32 10 87 20 </u></span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
...
//			var senderName = senderFullName.split(' ');
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rI hope this e-mail finds you well.<br><br>I would like to follow up with you, and make sure that you received invoice #'+thisInvoiceName+' expected to be due in about a week - '+dueDateFormat+'.<br><br>Your confirmation will be greatly appreciated.<br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog LTD </span><br><span style="color:#a9a9a9"> Tel. <u>+972-9-8941444</u> | U.S Toll Free Number: <u>1-888-70-40-670</u> </span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rI hope this e-mail finds you well.<br><br>I would like to follow up with you, and make sure that you received invoice #'+thisInvoiceName+' expected to be due in about a week - '+dueDateFormat+'.<br><br>Your confirmation will be greatly appreciated.<br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog SAS </span><br><span style="color:#a9a9a9"> Tel. <u>+33 (0)5 32 10 87 20 </u></span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
...
//			var senderName = senderFullName.split(' ');
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rI would like to inform you that we have not received payment per invoice #'+thisInvoiceName+'.<br>Please update us with payment status. Kindly note that payment due date was '+dueDateFormat+thisInvoiceTerms+'.<br><br>Thanks in advance,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog LTD </span><br><span style="color:#a9a9a9"> Tel. <u>+972-9-8941444</u> | U.S Toll Free Number: <u>1-888-70-40-670</u> </span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rI would like to inform you that we have not received payment per invoice #'+thisInvoiceName+'.<br>Please update us with payment status. Kindly note that payment due date was '+dueDateFormat+thisInvoiceTerms+'.<br><br>Thanks in advance,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog SAS </span><br><span style="color:#a9a9a9"> Tel. <u>+33 (0)5 32 10 87 20 </u></span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
...
//			var senderName = senderFullName.split(' ');
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rUnfortunately we still have not received payment per invoice #'+thisInvoiceName+' which is <b>'+daysOverDue+'</b> - due date was '+dueDateFormat+'.<br><br>Please complete payment ASAP.<br><br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog LTD </span><br><span style="color:#a9a9a9"> Tel. <u>+972-9-8941444</u> | U.S Toll Free Number: <u>1-888-70-40-670</u> </span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rUnfortunately we still have not received payment per invoice #'+thisInvoiceName+' which is <b>'+daysOverDue+'</b> - due date was '+dueDateFormat+'.<br><br>Please complete payment ASAP.<br><br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog SAS </span><br><span style="color:#a9a9a9"> Tel. <u>+33 (0)5 32 10 87 20 </u></span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
...
//			var senderName = senderFullName.split(' ');
			...
			var msg = 'Dear '+contactFirstName+',<br><br> \n\rWe have tried reaching you numerous times with regards to the unpaid invoice.<br>This has now become critical for us, your urgent attention to this matter will be greatly appreciated.<br><br>Thank you in advance for your prompt response.<br><br>Looking forward to your reply.<br>Best regards,<br>'+senderFirstName+'<br><br><span style="color:#43a047"> Accounts Receivable | JFrog SAS </span><br><span style="color:#a9a9a9"> Tel. <u>+33 (0)5 32 10 87 20 </u></span><br><br>';
			var attachRec = new Object(); 
			attachRec['entity']=customerID; //attach email to customer record
			attachRec['transaction']=thisInvoice; //attach email to invoice record
			//multiple email addresses
