...
function firstmail_SaveRecord(){
	...
	if(toSendLineCount != 0) {
		...
		for(var i = 0; i<toSendLineCount; i++) {
			...
			var toSend_period = nlapiGetLineItemValue('custpage_results_sublist', 'custpage_resultssublist_accountperiod', i +1);
			...
			var toSend_printName = nlapiGetLineItemValue('custpage_results_sublist', 'custpage_resultssublist_printname', i +1);
			var toSend_printEmail = nlapiGetLineItemValue('custpage_results_sublist', 'custpage_resultssublist_printemail', i +1);
			...
			var toSend_createdby = nlapiGetLineItemValue('custpage_results_sublist', 'custpage_resultssublist_createdby', i +1);
	...
	if(toRemoveLineCount != 0) {
		...
		for(var i = 0; i<toRemoveLineCount; i++) {
			...
			var toRemove_period = nlapiGetLineItemValue('custpage_toremove_sublist', 'custpage_toremove_accountperiod', i +1);
			...
			var toRemove_printName = nlapiGetLineItemValue('custpage_toremove_sublist', 'custpage_toremove_printname', i +1);
			var toRemove_printEmail = nlapiGetLineItemValue('custpage_toremove_sublist', 'custpage_toremove_printemail', i +1);
			...
			var toRemove_createdby = nlapiGetLineItemValue('custpage_toremove_sublist', 'custpage_toremove_createdby', i +1);
