...
//	if(openbalanceLines[i].exsists != 'yes') {
		...
		resultsSubList.setLineItemValue('custpage_resultssublist_type',i+1 ,clean_openbalanceLines[i].asset);
		resultsSubList.setLineItemValue('custpage_resultssublist_asset',i+1 ,clean_openbalanceLines[i].asset_type);
...
//			}
		...
		//	total_OBDPRN = parseFloat(OBcheckDPRN+checkDprn+checkDprn_Disposal+checkDprn_WriteDown);
			...
			resultsSubList.setLineItemValue('custpage_resultssublist_type',lineCounter ,theLines[i][0].asset);
			resultsSubList.setLineItemValue('custpage_resultssublist_asset',lineCounter ,theLines[i][0].asset_type);
