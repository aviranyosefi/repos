...
try{
	...
	nlapiSubmitField('customer', recID, 'custentity_vot_primary_contact', contact[0].contact_name, null);
...
nlapiLogExecution('debug', 'err', err)
	nlapiSubmitField('customer', recID, 'custentity_vot_primary_contact', '', null);
...
function getCustomersContacts(company) {
	...
	var searchContacts = nlapiLoadSearch(null, 'customsearch_vot_contact_search');
