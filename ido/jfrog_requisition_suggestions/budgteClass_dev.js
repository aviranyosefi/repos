...
var checkUser;
	...
	function budgetClass_suggestions_PageInit(type){
		...
		if(getContext.role == '1024' || '1047' || '1022' || '1054') {
...
//				
	...
	function setItem() {
		...
		filters[2] = new nlobjSearchFilter('custrecord_ilo_budget_owner', null, 'is', BudgetRequestor)
		var cols = new Array();
...
//
//	var getAllEmployees = nlapiSearchRecord('employee', null, null, cols);
//
//	if (getAllEmployees != null) {
//
//		getAllEmployees.forEach(function(element) {
//
//			allEmployees.push(element.getValue('internalid'));
//
//		});
//
//	}
