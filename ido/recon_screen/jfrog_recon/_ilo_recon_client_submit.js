...
//				if(thisAcc == currAccount) {				
					currRec.setLineItemValue('line', 'custcol_ilo_recon_session_col', parseInt(jeLineNum), toUpdate[i].recon_sessionID);
					currRec.setLineItemValue('line', 'custcol_ilo_recon_check_col', parseInt(jeLineNum), 'T');
					currRec.setLineItemValue('line', 'custcol_ilo_recon_memo_col', parseInt(jeLineNum), toUpdate[i].recon_memo);
...
//			}
		...
		if(toUpdate[i].rec_type == 'Check') {// api points - 30
			...
			currRec.setFieldValue('entity', '2238') //recon check vendor
