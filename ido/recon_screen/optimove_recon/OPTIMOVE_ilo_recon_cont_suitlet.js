...
function cc_recon_cont(request, response){
...

	   {
	     ...
	     for( var i = 0; i<dataArr.length; i++) {
	    	 ...
	    	 if(dataArr[i].sessionBook != null || undefined) {
	    		 
	    		 selectedBook = dataArr[i].sessionBook;
	    	 }
	    	 
	    	 if(dataArr[i].sessionValBy != null || undefined) {
	    		 
	    		 selectedValBy = dataArr[i].sessionValBy;
	    	 }
 
	    	 if(dataArr[i].lineNum != undefined || null ) {
	    		 
	    		 recsAndLines.push({
	    			 docID : dataArr[i].rec_id,
	    			 docLine : dataArr[i].lineNum, 
	    	 });
	     ...
	     sessionBook.setDefaultValue(selectedBook);
	     ...
	     sessionValBy.setDefaultValue(selectedValBy);
