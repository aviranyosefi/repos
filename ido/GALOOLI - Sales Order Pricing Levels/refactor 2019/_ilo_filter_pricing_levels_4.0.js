...
function itemSelected(type, name) {
	...
	if (type == 'item' && name == 'item' && role != '14') {
		
		console.log('field-change fired')
		var currItem = nlapiGetCurrentLineItemValue('item', 'item');
		console.log('field-change fired currItem : ' + currItem)
	...
	if (type == 'item' && name == 'price' && role != '14') {
	...
	if (type == 'item' && name == 'quantity' && role != '14') {
...
function validateLineDiscount() {
	...
	if(type == 'create' || type =='edit') {
	console.log('validate line fired')
