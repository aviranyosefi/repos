...
function checkSOForUpdates_workato(type) {
        ...
        try {
            ...
            if (postData != null) {
                ...
                nlapiLogExecution('debug', 'field was changed - postData', JSON.stringify(postData));
              	var headers = {"Authorization" : "workato-webhook@jfrog.com_1234qwer", "Content-Type": "application/json"}
    ...
    function checkForChanges(recID, isCancel, invoiceCreated) {
        ...
        if (invoiceCreated && !isCancel) {
            ...
            //var res = searchInvoice(recID) // 16.5.19 by aviran
            //invoiceNumber = "";
            // invoiceNumber = res; 
            // if (invoiceNumber == "" || invoiceNumber == null || invoiceNumber == undefined) invoiceNumber = "";
