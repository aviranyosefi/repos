...
function workflowAction_secondmail() {
	...
	'We wrote to you recently reminding you of the outstanding amount of <span style="background-color: rgb(255, 255, 255);"> '+tranTotal+' '+tranCurrency+'</span> for invoice# '+tranid+',<br>' +
	'but it appears to remain unpaid. If you have any queries regarding its payment or if we can help you in any way, please contact us.<br>' +
	'If not, please organize for settlement of this invoice immediately, as it is <span style="color:#FF0000;"><strong><span dir="RTL">14</span> </strong></span> days past due.<br><br>' +
